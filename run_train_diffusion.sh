...
ln -sfn /checkpoint/${USER}/${SLURM_JOB_ID} $PWD/PositionDiffusionPolicy/checkpoint/${SLURM_JOB_ID}
...
python -m diffusion_policy.train --config-name=train_diffusion_unet_lowdim_workspace training.job_id=${SLURM_JOB_ID}