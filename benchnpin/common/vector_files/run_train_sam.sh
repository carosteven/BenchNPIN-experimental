...
ln -sfn /checkpoint/${USER}/${SLURM_JOB_ID} $PWD/benchnpin/baselines/box_pushing/SAM/checkpoint/${SLURM_JOB_ID}
...
python $PWD/tests/box_pushing_baselines.py --job_id ${SLURM_JOB_ID} --config_file $PWD/benchnpin/environments/box_pushing/config_sam.yaml